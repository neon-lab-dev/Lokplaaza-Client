      ...
      <Container>
        <div className="py-16 md:py-24">
          ...
          <div className="text-center mb-12 max-w-3xl mx-auto">
            <Heading title={data.heading} alignClass="text-center" />
            <p className="text-lg text-neutral-600 mt-4">{data.description}</p>
          </div>
          ...
          {slug === "modular-kitchen" ? (
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {data?.images?.map((img: any, index: number) => (
                <div
                  key={index}
                  className="group relative w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)]"
                  style={{
                    maxWidth: "400px",
                    flexGrow: 1,
                  }}
