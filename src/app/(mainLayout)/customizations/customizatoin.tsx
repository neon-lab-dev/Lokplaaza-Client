...
const customizationOptions = {
  reclinerType: [
    {
      ...
      description:
        "Budget-friendly mechanism operated manually with lever control.",
      value: "manual",
      priceImpact: 0,
    },
    {
      ...
      description:
        "Smooth and motorized recline action with remote/button control.",
      value: "power",
      priceImpact: 12000,
    },
    {
      ...
      description:
        "Designed to reduce stress on the spine and distribute weight evenly.",
      value: "zero_gravity",
      priceImpact: 22000,
    },
  ],
  ...
  armrestType: [
    ...
    },
    {
      label: "Pillow Top",
      description:
        "Soft cushioned design ideal for lounging and extended comfort.",
      value: "pillow_top",
      priceImpact: 6500,
    },
  ],
  ...
  middleConsole: [
    ...
    },
    {
      ...
      description:
        "Integrated console with dual cup holders and small utility tray.",
      value: "cup_holders",
      priceImpact: 3500,
    },
    {
  ...
  seatType: [
    ...
    },
    {
      label: "Firm",
      description:
        "Support-focused seating great for posture and long sitting.",
      value: "firm",
      priceImpact: 2000,
    },
  ],
  ...
  backHeight: [
    {
      label: "Low Back",
      description:
        "Minimal style with modern aesthetics and lower head support.",
      value: "low",
      priceImpact: 0,
    },
    {
    ...
    {
      label: "High Back",
      description: "Max cushioning designed for head, neck and spinal support.",
      value: "high",
      priceImpact: 5000,
    },
  ],
